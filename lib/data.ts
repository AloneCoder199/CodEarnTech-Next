...
export const courses: ICourse[] = [
  {
    id: "1",
    slug: "full-stack-saas-mastery",
    title: "Full-Stack SaaS Mastery",
    shortTitle: "SaaS Mastery",
    description: "Complete guide to building production-ready SaaS applications from scratch. Learn architecture, authentication, payments, deployments, and scaling.",
    shortDescription: "Build production-ready SaaS apps with modern stack",
    level: "Advanced",
    duration: "24 Weeks",
    totalModules: 12,
    totalTopics: 156,
    price: 20000,
    discountPrice: 10000,
    thumbnail: "/courses/saas-mastery.jpg",
    icon: "🚀",
    ...
    tags: ["SaaS", "Next.js", "PostgreSQL", "Stripe", "Docker"],
    modules: [
      {
        id: "m1",
        title: "SaaS Foundations & Architecture",
        description: "Understanding SaaS business models and technical architecture",
        order: 1,
        isPreview: true,
        topics: [
          { id: "t1", title: "What is SaaS? Business Models Explained", description: "Understanding SaaS fundamentals", duration: "45 min", isPreview: true },
          { id: "t2", title: "Multi-tenant Architecture Patterns", description: "Database strategies for multi-tenancy", duration: "60 min", isPreview: true },
          { id: "t3", title: "Tech Stack Selection", description: "Choosing right tools for SaaS", duration: "50 min", isPreview: false },
          { id: "t4", title: "Project Setup & Monorepo Structure", description: "Turborepo and pnpm workspace setup", duration: "55 min", isPreview: false },
          { id: "t5", title: "Environment Configuration", description: "Managing dev/staging/prod environments", duration: "40 min", isPreview: false },
          { id: "t6", title: "Code Quality & Linting Setup", description: "ESLint, Prettier, Husky configuration", duration: "35 min", isPreview: false },
          { id: "t7", title: "Component Library Architecture", description: "Building reusable UI components", duration: "65 min", isPreview: false },
          { id: "t8", title: "Design System Implementation", description: "Creating consistent design language", duration: "70 min", isPreview: false }
        ]
      },
      {
        id: "m2",
        ...
        isPreview: false,
        topics: [
          { id: "t9", title: "Auth Architecture Planning", description: "Planning authentication flow", duration: "40 min", isPreview: false },
          { id: "t10", title: "NextAuth.js Integration", description: "OAuth providers setup", duration: "55 min", isPreview: false },
          { id: "t11", title: "JWT vs Session Strategies", description: "Token management deep dive", duration: "50 min", isPreview: false },
          { id: "t12", title: "Role-Based Access Control (RBAC)", description: "Implementing user roles", duration: "60 min", isPreview: false },
          { id: "t13", title: "Organization/Team Support", description: "Multi-user accounts", duration: "75 min", isPreview: false },
          { id: "t14", title: "Permission Systems", description: "Granular permissions", duration: "65 min", isPreview: false },
          { id: "t15", title: "Magic Links & Passwordless", description: "Modern auth methods", duration: "45 min", isPreview: false },
          { id: "t16", title: "Two-Factor Authentication", description: "2FA implementation", duration: "55 min", isPreview: false },
          { id: "t17", title: "Security Best Practices", description: "OWASP guidelines", duration: "70 min", isPreview: false },
          { id: "t18", title: "Auth Testing Strategies", description: "Unit and integration tests", duration: "50 min", isPreview: false }
        ]
      },
      {
        id: "m3",
        title: "Database Design & ORM",
        description: "PostgreSQL, Prisma, and advanced querying",
        order: 3,
        isPreview: false,
        topics: [
          { id: "t19", title: "Database Schema Design", description: "Relational database principles", duration: "60 min", isPreview: false },
          { id: "t20", title: "Prisma ORM Deep Dive", description: "Models and migrations", duration: "65 min", isPreview: false },
          { id: "t21", title: "Multi-tenant Data Isolation", description: "Row-level security", duration: "70 min", isPreview: false },
          { id: "t22", title: "Advanced Queries & Optimization", description: "Indexing strategies", duration: "75 min", isPreview: false },
          { id: "t23", title: "Connection Pooling", description: "PgBouncer and serverless", duration: "50 min", isPreview: false },
          { id: "t24", title: "Database Migrations", description: "Version control for schema", duration: "45 min", isPreview: false },
          { id: "t25", title: "Backup & Recovery", description: "Disaster planning", duration: "55 min", isPreview: false },
          { id: "t26", title: "Redis Caching Layer", description: "Caching strategies", duration: "60 min", isPreview: false }
        ]
      },
      {
        id: "m4",
        ...
        isPreview: false,
        topics: [
          { id: "t27", title: "Stripe Account Setup", description: "Merchant configuration", duration: "40 min", isPreview: false },
          { id: "t28", title: "Subscription Models", description: "Flat, tiered, usage-based", duration: "55 min", isPreview: false },
          { id: "t29", title: "Checkout Sessions", description: "Payment flows", duration: "60 min", isPreview: false },
          { id: "t30", title: "Webhook Handling", description: "Secure webhook processing", duration: "65 min", isPreview: false },
          { id: "t31", title: "Invoice Management", description: "Billing history", duration: "50 min", isPreview: false },
          { id: "t32", title: "Failed Payment Recovery", description: "Dunning management", duration: "45 min", isPreview: false },
          { id: "t33", title: "Tax & Compliance", description: "VAT and sales tax", duration: "55 min", isPreview: false },
          { id: "t34", title: "Usage-Based Billing", description: "Metered billing setup", duration: "70 min", isPreview: false }
        ]
      },
      {
        id: "m5",
        title: "Frontend Architecture",
        description: "Advanced Next.js patterns and performance",
        order: 5,
        isPreview: false,
        topics: [
          { id: "t35", title: "App Router Deep Dive", description: "Next.js 14+ features", duration: "65 min", isPreview: false },
          { id: "t36", title: "Server Components Pattern", description: "RSC architecture", duration: "70 min", isPreview: false },
          { id: "t37", title: "Streaming & Suspense", description: "Progressive loading", duration: "60 min", isPreview: false },
          { id: "t38", title: "State Management", description: "Zustand vs Redux vs Context", duration: "75 min", isPreview: false },
          { id: "t39", title: "Real-time with WebSockets", description: "Live updates", duration: "65 min", isPreview: false },
          { id: "t40", title: "File Uploads & Storage", description: "S3 integration", duration: "55 min", isPreview: false },
          { id: "t41", title: "Search Implementation", description: "Algolia/Typesense", duration: "70 min", isPreview: false },
          { id: "t42", title: "Notifications System", description: "Email, push, in-app", duration: "60 min", isPreview: false }
        ]
      },
      {
        id: "m6",
        ...
        isPreview: false,
        topics: [
          { id: "t43", title: "API Architecture", description: "REST vs GraphQL vs tRPC", duration: "55 min", isPreview: false },
          { id: "t44", title: "tRPC Implementation", description: "Type-safe APIs", duration: "70 min", isPreview: false },
          { id: "t45", title: "Rate Limiting", description: "Throttling strategies", duration: "50 min", isPreview: false },
          { id: "t46", title: "API Versioning", description: "Backward compatibility", duration: "45 min", isPreview: false },
          { id: "t47", title: "Documentation with OpenAPI", description: "Swagger setup", duration: "40 min", isPreview: false },
          { id: "t48", title: "Background Jobs", description: "BullMQ and queues", duration: "65 min", isPreview: false },
          { id: "t49", title: "Cron Jobs & Scheduling", description: "Automated tasks", duration: "50 min", isPreview: false },
          { id: "t50", title: "Serverless Functions", description: "Edge functions", duration: "60 min", isPreview: false }
        ]
      },
      {
        id: "m7",
        ...
        isPreview: false,
        topics: [
          { id: "t51", title: "Docker Containerization", description: "Dockerfile best practices", duration: "70 min", isPreview: false },
          { id: "t52", title: "Docker Compose", description: "Local development", duration: "55 min", isPreview: false },
          { id: "t53", title: "GitHub Actions CI/CD", description: "Automated pipelines", duration: "75 min", isPreview: false },
          { id: "t54", title: "Vercel Deployment", description: "Edge network", duration: "45 min", isPreview: false },
          { id: "t55", title: "AWS/GCP Basics", description: "Cloud fundamentals", duration: "80 min", isPreview: false },
          { id: "t56", title: "Kubernetes Intro", description: "Container orchestration", duration: "90 min", isPreview: false },
          { id: "t57", title: "Environment Management", description: "Secrets and configs", duration: "50 min", isPreview: false },
          { id: "t58", title: "Database Deployment", description: "RDS and managed DBs", duration: "65 min", isPreview: false }
        ]
      },
      {
        id: "m8",
        ...
        isPreview: false,
        topics: [
          { id: "t59", title: "Testing Pyramid", description: "Unit, integration, e2e", duration: "45 min", isPreview: false },
          { id: "t60", title: "Jest & Vitest", description: "Unit testing", duration: "60 min", isPreview: false },
          { id: "t61", title: "React Testing Library", description: "Component testing", duration: "65 min", isPreview: false },
          { id: "t62", title: "Playwright E2E", description: "End-to-end testing", duration: "70 min", isPreview: false },
          { id: "t63", title: "API Testing", description: "Supertest and MSW", duration: "55 min", isPreview: false },
          { id: "t64", title: "Visual Regression", description: "Chromatic/Storybook", duration: "50 min", isPreview: false },
          { id: "t65", title: "Performance Testing", description: "Lighthouse CI", duration: "45 min", isPreview: false },
          { id: "t66", title: "Coverage Reports", description: "Code quality metrics", duration: "40 min", isPreview: false }
        ]
      },
      {
        id: "m9",
        ...
        isPreview: false,
        topics: [
          { id: "t67", title: "Security Headers", description: "HSTS, CSP, X-Frame", duration: "50 min", isPreview: false },
          { id: "t68", title: "CSRF & XSS Protection", description: "Attack prevention", duration: "60 min", isPreview: false },
          { id: "t69", title: "Data Encryption", description: "At-rest and in-transit", duration: "55 min", isPreview: false },
          { id: "t70", title: "GDPR Compliance", description: "Data privacy laws", duration: "65 min", isPreview: false },
          { id: "t71", title: "SOC2 Basics", description: "Security audits", duration: "70 min", isPreview: false },
          { id: "t72", title: "Penetration Testing", description: "Security assessments", duration: "75 min", isPreview: false },
          { id: "t73", title: "Dependency Security", description: "Snyk/Dependabot", duration: "45 min", isPreview: false },
          { id: "t74", title: "Incident Response", description: "Security breaches", duration: "60 min", isPreview: false }
        ]
      },
      {
        id: "m10",
        title: "Analytics & Monitoring",
        description: "Observability and user analytics",
        order: 10,
        isPreview: false,
        topics: [
          { id: "t75", title: "Analytics Architecture", description: "Event tracking design", duration: "55 min", isPreview: false },
          { id: "t76", title: "Segment/Mixpanel", description: "Product analytics", duration: "60 min", isPreview: false },
          { id: "t77", title: "Error Tracking", description: "Sentry integration", duration: "50 min", isPreview: false },
          { id: "t78", title: "Performance Monitoring", description: "Real user metrics", duration: "55 min", isPreview: false },
          { id: "t79", title: "Log Management", description: "Centralized logging", duration: "50 min", isPreview: false },
          { id: "t80", title: "Alerting Systems", description: "PagerDuty/Opsgenie", duration: "45 min", isPreview: false },
          { id: "t81", title: "Dashboard Creation", description: "Grafana/DataDog", duration: "65 min", isPreview: false },
          { id: "t82", title: "A/B Testing", description: "Experimentation", duration: "60 min", isPreview: false }
        ]
      },
      {
        id: "m11",
        title: "Scaling & Performance",
        description: "Handling growth and optimization",
        order: 11,
        isPreview: false,
        topics: [
          { id: "t83", title: "Load Balancing", description: "Traffic distribution", duration: "55 min", isPreview: false },
          { id: "t84", title: "Horizontal Scaling", description: "Auto-scaling groups", duration: "70 min", isPreview: false },
          { id: "t85", title: "Database Sharding", description: "Partitioning strategies", duration: "80 min", isPreview: false },
          { id: "t86", title: "CDN Implementation", description: "CloudFront/Fastly", duration: "50 min", isPreview: false },
          { id: "t87", title: "Edge Computing", description: "Vercel Edge/Cloudflare", duration: "65 min", isPreview: false },
          { id: "t88", title: "Microservices", description: "Service decomposition", duration: "90 min", isPreview: false },
          { id: "t89", title: "Event-Driven Architecture", description: "Kafka/EventBridge", duration: "85 min", isPreview: false },
          { id: "t90", title: "Cost Optimization", description: "Cloud cost management", duration: "60 min", isPreview: false }
        ]
      },
      {
        id: "m12",
        title: "Launch & Growth",
        description: "Go-to-market and scaling",
        order: 12,
        isPreview: false,
        topics: [
          { id: "t91", title: "Pre-launch Checklist", description: "Production readiness", duration: "50 min", isPreview: false },
          { id: "t92", title: "Beta Testing", description: "Early access program", duration: "45 min", isPreview: false },
          { id: "t93", title: "Product Hunt Launch", description: "Marketing strategies", duration: "60 min", isPreview: false },
          { id: "t94", title: "Customer Onboarding", description: "User activation", duration: "55 min", isPreview: false },
          { id: "t95", title: "Support Systems", description: "Zendesk/Intercom", duration: "50 min", isPreview: false },
          { id: "t96", title: "Feature Flags", description: "LaunchDarkly", duration: "55 min", isPreview: false },
          { id: "t97", title: "Churn Reduction", description: "Retention strategies", duration: "65 min", isPreview: false },
          { id: "t98", title: "Scaling Team", description: "Hiring and culture", duration: "70 min", isPreview: false }
        ]
      }
    ]
  },
